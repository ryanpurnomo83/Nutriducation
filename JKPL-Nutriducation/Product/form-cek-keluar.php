...
<body>
    ...
    <h2>Checkout Form</h2>
    <p>Isikan data diri lengkap dibawah iin untuk memilih metode pembayaran.</p>
    <div class="row">
        <div class="col-75">
            <div class="container">
                <form action="/action_page.php">
                    ...
                    <label>
                        <input type="checkbox" checked="checked" name="sameadr"> Alamat Pengantaran sama dengan Alamat Pembayar
                    </label>
        ...
        <div class="col-25">
            <div class="container">
                ...
                <p><a href="#">Produk 3</a> <span class="price">$8</span></p>
